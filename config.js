...
global.github=process.env.GITHUB|| "https://github.com/254100934193/Yobih-bot";
...
global.devs = "254743436105" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "null";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "254743436105";
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "254743436105,923xxxxxxxx";
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ Yobih_bot 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "Yobih_Bot",
  ownername:process.env.OWNER_NAME|| "Yobih-MD",
